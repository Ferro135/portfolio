...
export default function NotFound() {
  return (
    <main id="conteudo" className="grid min-h-screen place-items-center bg-nexora-bg px-6 text-white">
      <div className="relative w-full max-w-2xl overflow-hidden rounded-[28px] border border-white/10 bg-[#0a1222cc] p-8 text-center shadow-2xl md:p-14">
        ...
        <div className="relative">
          <NexoraLogo className="mx-auto mb-8 h-auto w-40" />
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-slate-400 md:text-base">
            O endereço pode ter mudado ou sido digitado incorretamente. Volte ao portfólio para continuar explorando a NEXORA.
          </p>
