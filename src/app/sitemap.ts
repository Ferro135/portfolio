...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const paths = [
    ...
    ["/en",0.8,"monthly"],["/en/about",0.5,"monthly"],["/en/services",0.7,"monthly"],["/en/projects",0.7,"monthly"],["/en/results",0.5,"monthly"],["/en/contact",0.6,"monthly"],["/en/schedule",0.5,"monthly"],["/en/projects/zentra",0.6,"monthly"],["/en/projects/spazio-management",0.6,"monthly"]
  ] as const;
  return [
